...
<div class="grid-container">
    ...
    <header>
			...
			<span class="cell"><h1>Answer Question</h1></span>
    </header>
	</div>
   ...
   <div class="container">
                ...
                <div class="span10 offset1">
                    <div class="row">
						...
						<?php $qid = $_REQUEST['question_id'];?>
                    </div>
					<?php echo '<form class="form-horizontal" autocomplete="off" action="../controller/addAnswer.php?question_id='.$_REQUEST['question_id'].'" method="post">';?>
	  
		<div class="control-group">
             <label class="control-label">Answer</label>
                <div class="controls">
                    <input name="answer" class="form-control" required   type="text"  placeholder="Answer">
				</div>
        </div>
		</br>
		<?php if(!isset($_SESSION['id'])){?>
		<div class="control-group">
             <label class="control-label">Name of Answerer</label>
                <div class="controls">
                    <input name="poster" required class="form-control" type="text" placeholder="Answerer">
				</div>
        </div>
		</br>
		<?php } ?>
